...
\clist_new:c { propbox_properties }
...
\NewDocumentCommand{\DeclareBoxProperty}{m}{
  ...
  \clist_set:Nn \propbox_properties { #1 }
  \propbox_properties_update
  \propbox_debug_msg { Complete! }
  \propbox_debug_msg { Here~are~the~new~properties: }
  \propbox_if_debug { \clist_show:N \propbox_properties }
}
